...
class Config:
    LICHESS_TOKEN: str = "YOUR_LICHESS_TOKEN"
    STOCKFISH_PATH: str = r"path\to\stockfish"
    BOOK_PATH: str = "example.bin"
    ...
    CHAT_GREET: str = "Hi! I'm OpeningTrainer—I'll play perfect theory, then match your level. Good luck!"
